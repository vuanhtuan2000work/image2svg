...
def infer_frame_ml_landmarks(
    *,
    ...
    from svg_analyze.compiler.pass1_raster import crop_alpha_to_bbox, crop_rgba_to_bbox, rgba_crop_to_png_bytes
...
def _try_mmpose(png_bytes: bytes, frame_bbox: BBox) -> dict[str, Any]:
    try:
        from svg_analyze.ml.mmpose_backend import infer_animal_pose
    except ImportError as exc:
        return {"status": "skipped", "reason": f"mmpose_backend unavailable: {exc}"}
