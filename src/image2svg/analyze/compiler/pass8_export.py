...
from image2svg.analyze.compiler.pass1_raster import foreground_bbox_from_paths, tight_content_bbox_for_frame
from image2svg.analyze.geometry import BBox, frame_to_core_matrix, union_bbox
from image2svg.analyze.export.phaser_manifest import build_game_manifest_from_export
from image2svg.analyze.legacy_pipeline import _frame_quality, _guess_background
from image2svg.analyze.types import CompilerState, FrameSplitCandidate, FrameSplitScoreBreakdown, LandmarkCandidate
...
def _guess_background_legacy(paths) -> str:
    from image2svg.analyze.legacy_pipeline import ParsedPath
