...
from image2svg.analyze.compiler.pass0_normalize import normalize_svg
from image2svg.analyze.compiler.pass1_raster import extract_raster_evidence, foreground_bbox_from_paths
from image2svg.analyze.compiler.pass2_frames import assign_paths_to_frames, generate_frame_candidates, select_frame_split
from image2svg.analyze.compiler.pass3_scene_graph import build_scene_graph, cluster_visual_components
from image2svg.analyze.compiler.pass4_core_view import detect_core_body_region, estimate_view_state
from image2svg.analyze.compiler.pass5_skeleton import fit_skeleton_with_constraints, generate_landmark_candidates
from image2svg.analyze.compiler.pass5b_ml_landmarks import ml_landmarks_enabled, mmpose_enabled
from image2svg.analyze.compiler.pass6_parts import infer_semantic_parts
from image2svg.analyze.compiler.pass7_temporal import (
    apply_temporal_label_repair,
    build_temporal_analysis,
    track_parts_across_frames,
)
from image2svg.analyze.compiler.pass8_export import export_analysis
from image2svg.analyze.correction_memory import apply_correction_priors
from image2svg.analyze.legacy_pipeline import _quality_report
from image2svg.analyze.types import CompilerState
...
def compile_svg(
    ...
    *,
    ...
    if use_ml_landmarks:
        ...
        if use_mmpose:
            from image2svg.analyze.ml.landmarks import get_mmpose_readiness
