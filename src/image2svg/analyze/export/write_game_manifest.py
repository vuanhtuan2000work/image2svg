...
from image2svg.analyze.export.phaser_manifest import build_game_manifest_from_export, display_scale_for_svg
from image2svg.paths import repo_root
...
# Optional sibling game project for Phaser export integrations.
DEFAULT_GAME_ROOT = repo_root().parent / "game-2d" / "feed-your-pet"
